...
- **Read before you write.** When I ask you to add to this repo, first check the relevant folder (`methodology/`, `conventions/`, `templates/`, `learnings/`) for existing content so you don't duplicate or contradict it.
- **Distinguish the four kinds of content.**
