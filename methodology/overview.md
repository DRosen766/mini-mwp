...
- `task-pickup.md` — how the agent picks the next stage, why it drains the current phase before switching, and the two carve-outs (hard blocker, explicit override).
